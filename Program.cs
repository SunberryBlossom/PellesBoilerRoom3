...
namespace The_OOP_Hotel_part_two
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            hotelStaff.Add(new Manager { Name = "Maria Svensson", Age = 45, EmployeeId = "M002", Department = "Operations", Salary = 55000m, StartDate = new DateTime(2018, 5, 1), BonusPercentage = 0.15m });
